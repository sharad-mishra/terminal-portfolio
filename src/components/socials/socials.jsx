...
function Socials(){
    return (
        <>
            ...
            <Output>
                <span>LinkedIn: <span className="text-teal-500 font-bold underline cursor-pointer">https://www.linkedin.com/in/sharad-miishra/</span></span>
            </Output>
            <Output>
                <span>GitHub: <span className="text-teal-500 font-bold underline cursor-pointer">https://github.com/sharad-mishra</span></span>
            </Output>
